...
const About = () => {
    return (
        <div className="card m-3 border-3">
            ...
            <div className="card-body">
                ...
                <p className="card-text"> An Admin user is also there, who has the authority to update and delete user details. If a user is logging in, at the time login itself their role will be authorised and if the role is USER then user can be able to see thier profile. If the user is an ADMIN he can be able to see the dashboard specifically designed for ADMIN.</p>
            </div>
